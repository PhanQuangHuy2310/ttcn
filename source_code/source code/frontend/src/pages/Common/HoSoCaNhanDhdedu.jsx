            ...
            <div className="bg-surface-container-lowest rounded-xl shadow-[0px_12px_32px_rgba(0,28,56,0.06)] overflow-hidden relative">
              <div className="h-48 w-full bg-gradient-to-r from-primary to-primary-container relative">
                <img
                  ...
                  data-alt="University campus aerial photography background"
              ...
              <div className="px-8 pb-8 flex flex-col md:flex-row items-end -mt-12 gap-6 relative">
                <div className="relative group">
                  <img
                    ...
                    data-alt="Student headshot large display"
                ...
                <div className="bg-gradient-to-br from-secondary to-[#004a79] rounded-xl p-6 text-white shadow-xl relative overflow-hidden">
                  ...
                  <div className="flex items-center gap-4 mb-6 relative z-10">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] opacity-70">IT21A - CNTT</p>
                    </div>
                  </div>
                  <div className="flex justify-between items-end relative z-10">
                    ...
                    <img
                      ...
                      data-alt="Hidden tech detail"
                      src="https://lh3.googleusercontent.com/aida-public/AB6AXuDaAdcdheZRe9XBatXwCUb49HtmvaxybB9WmRT6BqN9DetqulfoxVad7gbP1HuCvC016uMNoVBSWr0fAn6ITFyPLpXUHm4lUroQlbDq6qS-VM6zMGo_p5PWkQi-H8oILwQrXKiJnECmTADDUuf3vzpQfAHNOFFd0q_OSUByUxiiux57-L0sAT3Da6fDh9i9T4IGbYEpSPVVeX37Omeb1anQmvv4dLGNFageV8ZjIg1_tqNWaAnW-je4hFqHIKSYIkbUXR8Gn2RN3bI"
                    />
