...
<p className="text-outline mt-1 font-body">Dưới đây là tổng quan hiệu suất hệ thống DHDedu hôm nay.</p>
</div>
...
<button className="px-5 py-2.5 bg-gradient-to-br from-primary to-primary-container text-white rounded-xl text-sm font-bold shadow-lg shadow-primary/20 hover:scale-[1.02] transition-transform flex items-center gap-2 font-body">
...
<select className="bg-surface-container border-none text-xs font-bold rounded-lg px-3 py-1.5 focus:ring-0 font-body">
...
<button className="text-primary text-sm font-bold hover:underline font-body">Xem tất cả</button>
</div>
...
<span className="text-on-surface-variant font-body">Uptime: 99.98%</span>
