...
const LamBaiTrucTuyenSinhVien = () => {
  return (
    <div className="stitch-screen w-full h-full min-h-screen bg-gray-50">
          ...
          <div className="bg-white rounded-3xl shadow-sm overflow-hidden flex flex-col min-h-[600px]">
            <div className="bg-slate-50 p-8 border-b border-slate-100">
              <div className="flex items-center gap-4 mb-4">
                <span className="bg-blue-700 text-white px-4 py-1.5 rounded-lg font-bold tracking-wider text-sm">
                  CÂU 05
                </span>
              ...
              <h2 className="text-2xl font-['Be_Vietnam_Pro'] font-bold text-slate-800 leading-relaxed">
      ...
      <button className="fixed bottom-8 right-8 w-16 h-16 rounded-full bg-primary text-white shadow-2xl flex items-center justify-center md:hidden hover:scale-110 active:scale-95 transition-all">
